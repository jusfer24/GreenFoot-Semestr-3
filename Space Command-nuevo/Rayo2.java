...
/**
 * Write a description of class Rayo2 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Rayo2 extends Rayo
{
    /**
    ...
    private int appearDelay = 320; // Tiempo para que el rayo aparezca (3 segundos)
